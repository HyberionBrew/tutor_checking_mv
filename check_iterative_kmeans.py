...
if __name__ == '__main__':
    ...
    stop = time.time()
    print("Time for Iterative k-means: ", stop - start)
    plot_clustering_results(scene_pcd,
                            labels,
                            "Iterative k-means Solution")
    
    time_start = time.time()
    centers, labels = student_module.iterative_kmeans(points,
                                        max_n_clusters=iterative_kmeans_max_clusters,
                                        n_iterations=kmeans_iterations,
                                        max_singlerun_iterations=max_singlerun_iterations)
    time_end = time.time()
    print("Time for iterative kmeans: ", time_end - time_start)
    plot_clustering_results(scene_pcd,
                            labels,
                            "Iterative k-means")